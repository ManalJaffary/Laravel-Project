<x-hccheader title="Let's Vaxxed" />
<div class="row">
    <!-- card1 start -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-xl-4">
                <div class="card fb-card">
                    ...
                    <div class="card-block text-center">
                        <a class="btn btn-primary " target="" href="{{ URL::to('/vaccinator_users') }}">View All</a>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-xl-4">
            <div class="card dribble-card">
                ...
                <div class="card-block text-center">
                    <a class="btn btn-danger " target="" href="{{ URL::to('/parent_users') }}">View All</a>
                </div>
            </div>
            </div>
            <div class="col-md-6 col-xl-4">
                <div class="card twitter-card">
                    ...
                    <div class="card-block text-center">
                        <a class="btn btn-info " target="" href="{{ URL::to('/vaccine_record') }}">View All</a>
                    </div>
                </div>
                </div>
        </div>
