                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        @if(session()->has('hcc_id'))
                            <li class="user-profile header-notification">
                                <a href="#!">
                                    <img src="{{ URL::asset('uploads/hcc/'.$hcc_details['profile_picture']) }}" class="img-radius" alt="User-Profile-Image">
                                    <span>{{ $hcc_details['name'] }} </span>
                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            @if(session()->has('hcc_id'))
                                    {{--  <img class="img-40 img-radius" src="{{ URL::asset('uploads/admin/'.$admin_details['profile_picture']) }}" alt="User-Profile-Image">  --}}
                                    <div class="user-details">
                                        <span>{{ $hcc_details['name'] }} </span>
                                        <span id="more-details">{{ $hcc_details['type'] }}<i class="ti-angle-down"></i></span>
                                    </div>
                                </div>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="pcoded-hasmenu">
                                    ...
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="{{ URL::to('/vaccinator_users') }}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Vaccinators</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="{{ URL::to('/parent_users') }}">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Parents</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                {{-- <li>
                                    <a href="{{ URL::to('/registerchild') }}">
                                        <span class="pcoded-micon" style="background-color: #7ceeaf"><i class="fa fa-child"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Child Registration</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li> --}}
                                <li>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms">Appointment Panel</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li>
                                    <a href="{{ URL::to('/add_vaccine') }}">
                                        <span class="pcoded-micon"style="background-color: orange"><i class="fa fa-syringe"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.form-components.main">Add Vaccine</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ URL::to('/vaccine_record') }}">
