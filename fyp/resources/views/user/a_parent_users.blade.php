        ...
        <div class="modal" id="myModal">
            ...
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h4 class="modal-title">Register New Parent</h4>
                ...
                <form action="{{ URL::to('/insertUsers') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <br>
                            <input type="text" placeholder="Enter Password" name="password" style="width: 320px; height:40px;" required />
                        </div>
                        <div class="col-md-6">
                            <br>
                            <label>Gender:</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <label>HCC Id:</label>
                            <br>
                            <input type="text" placeholder="Enter HCC Id" name="hcc_id" style="width: 320px; height:40px;" required />
                        </div>
                        <div class="col-md-6">
                            <br>
                            <label>Type:</label>
                            <br>
                            <input type="text" placeholder="Enter Type" name="type" value="Parent" style="width: 320px; height:40px;" required />
                        </div>
                        <div class="col-md-6">
                            <br>
                            <label>Status:</label>
                ...
                <div class="card-block">
                    ...
                    <div class="row m-b-30">
                        <div class="col-lg-12 col-xl-12">
                            <div class="sub-title">Parents</div>
                            <!-- Nav tabs -->
